...
const uint8_t CyFxUSBHSConfigDscr[] =
    {
        ...
        0xE5, 0x00//0xE4,0x00,//0xF6,0x00,                      /* Length of this descriptor and all sub descriptors */
        0x03,                           /* Number of interfaces */
#else
        0x24, 0x01,//0xDF,0x00,                      /* Length of this descriptor and all sub descriptors */
        ...
        0x40,0x00,                      /* Max packet size = 1024: 0x00,0x04, (64: 0x40, 0x00) bytes */
        0x08,                           /* Servicing interval: 8 ms*/
       ...
       /* Class-specific Video Streaming Input Header Descriptor */
        ...
        0x75,0x00,                      /* Total size of Class specific VS descr: 0x51 Bytes*/
       ...
       /* Class specific Uncompressed VS Frame descriptor 1*/
        ...
        0xE0,0x01,
#else
        0x80,0x02, //640                     /* Width in pixel: 960(0xC0,0x03) or 640(0x80,0x02) */
        ...
        0x00,0xE0,0xD4,0x0E,//0x00,0x10,0x5C,0x0C,            /* Min bit rate bits/s. Not specified, taken from MJPEG */
        0x00,0xE0,0xD4,0x0E,            /* Max bit rate bits/s. Not specified, taken from MJPEG */
        0x00,0xB0,0x04,0x00,            /* Maximum video or still frame size in bytes(Deprecated) */
#ifndef CAM720
        0x15,0x16,0x05,0x00,            /* Default Frame Interval 30fps 0x15,0x16,0x05,0x00,*/
        0x01,                           /* Frame interval(Frame Rate) types: Only one frame interval supported */
        0x15,0x16,0x05,0x00,            /* Shortest Frame Interval 30fps :0x15,0x16,0x05,0x00, 25fps: 0x80,0x1a,0x06,0x00,*/
        ...
        0x05,//0x02, CY_U3P_USB_EP_ISO                          /* BULK End point */
        (uint8_t)(0x400 & 0x00FF),        /* High speed max packet size is always 512 bytes. */
        (uint8_t)(((0x400 & 0xFF00)>>8)|0x10),
       ...
       CY_FX_EP_BULK_VIDEO,            /* Endpoint address and description */
       0x05,//0x02, CY_U3P_USB_EP_ISO                          /* BULK End point */
       (uint8_t)(0x300 & 0x00FF),        /* High speed max packet size is always 512 bytes. */
       (uint8_t)(((0x300 & 0xFF00)>>8)|0x10),
       0x01,                            /* Servicing interval for data transfers */
...
const uint8_t CyFxUSBSSConfigDscr[] =
    {
        ...
        0x03,                           /* Number of interfaces */
#else
        0x08,0x01,//0xF1,0x00,//0xD9,0x00,//                      /* Length of this descriptor and all sub descriptors */
        0x02,                           /* Number of interfaces */
#endif
        0x01,                           /* Configuration number */
        0x00,                           /* Configuration string index */
        ...
        0x01,                           /* Interface number */
        0x00,                           /* Alternate setting number */
        0x00,                           /* Number of end points video + still image*/
        0x0E,                           /* Interface class : CC_VIDEO */
        0x02,                           /* Interface sub class : CC_VIDEOSTREAMING */
        0x00,                           /* Interface protocol code : Undefined */
        0x00,                           /* Interface descriptor string index */
       ...
       /* Class-specific Video Streaming Input Header Descriptor */
        ...
        0x00,0x48,0x3F,0x00,//0x00,0xA4,0x1F,0x00,            /* Maximum video or still frame size in bytes(Deprecated)*/
#ifndef CAM720
        0x15,0x16,0x05,0x00,            /* Default Frame Interval 30fps 0x15,0x16,0x05,0x00,*/
        0x01,                           /* Frame interval(Frame Rate) types: Only one frame interval supported */
        0x15,0x16,0x05,0x00,            /* Shortest Frame Interval 30fps :0x15,0x16,0x05,0x00, 25fps: 0x80,0x1a,0x06,0x00,*/
        ...
        CY_U3P_USB_ENDPNT_DESCR,        /* Endpoint Descriptor Type */
        CY_FX_EP_BULK_VIDEO,            /* Endpoint address and description */
        CY_U3P_USB_EP_ISO,//CY_U3P_USB_EP_BULK,             /* BULK End point */
        (uint8_t)(0x400 & 0x00FF),//CY_FX_EP_BULK_VIDEO_PKT_SIZE_L, /* EP MaxPcktSize: 1024B */
        (uint8_t)((0x400 & 0xFF00)>>8 | 0x10),//CY_FX_EP_BULK_VIDEO_PKT_SIZE_H, /* EP MaxPcktSize: 1024B */
        0x01,                           /* Servicing interval for data transfers */

        /* Super Speed Endpoint Companion Descriptor for the Streaming Video Data endpoint */
        0x06,                           /* Descriptor size */
        CY_U3P_SS_EP_COMPN_DESCR,       /* SS Endpoint Companion Descriptor Type */
        0x01,                           /* Max number of packets per burst: 15 */
        0x00,                           /* Attribute: Streams not defined */
        0x00,                           /* No meaning for bulk */
        0x0C,

        /* Standard Video Streaming Interface Descriptor (Alternate Setting 2) */
        0x09,                           /* Descriptor size */
        CY_U3P_USB_INTRFC_DESCR,        /* Interface Descriptor type */
        0x01,                           /* Interface number */
        0x02,                           /* Alternate setting number */
        ...
        CY_FX_EP_BULK_VIDEO,            /* Endpoint address and description */
        CY_U3P_USB_EP_ISO,//CY_U3P_USB_EP_BULK,             /* BULK End point */
        (uint8_t)(0xC00 & 0x00FF),//CY_FX_EP_BULK_VIDEO_PKT_SIZE_L, /* EP MaxPcktSize: 1024B */
        (uint8_t)((0xC00 & 0xFF00)>>8),//CY_FX_EP_BULK_VIDEO_PKT_SIZE_H, /* EP MaxPcktSize: 1024B */
        0x01,                           /* Servicing interval for data transfers */
